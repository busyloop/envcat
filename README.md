...
| OS           | Arch    | Version               |      |
| ------------ | ------- | --------------------- | ---- |
| OSX (Darwin) | x86_64  | 1.0.2 (latest)  | [Download](https://github.com/busyloop/envcat/releases/latest) |
| Linux        | x86_64  | 1.0.2 (latest)  | [Download](https://github.com/busyloop/envcat/releases/latest) |
| Linux        | aarch64 | 1.0.2 (latest)  | [Download](https://github.com/busyloop/envcat/releases/latest) |
